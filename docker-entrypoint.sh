...
echo ""
echo "MCP Endpoints:"
echo "  GET  /mcp                                    - MCP SSE connection (requires auth)"
echo "  POST /mcp                                    - MCP message endpoint"
echo ""
echo "Authorization Discovery (MCP Spec):"
echo "  GET  /mcp-metadata                           - Resource metadata endpoint"
echo "  GET  /.well-known/oauth-protected-resource   - Protected resource metadata"
echo "  GET  /.well-known/oauth-authorization-server - OAuth 2.0 AS metadata (RFC 8414)"
echo "  GET  /authorize                              - Authorization server metadata"
echo "  POST /token                                  - Token endpoint (not implemented)"
echo ""
echo "OAuth Flow:"
...
echo "  GET  /favicon.ico                            - Favicon image"
echo ""
