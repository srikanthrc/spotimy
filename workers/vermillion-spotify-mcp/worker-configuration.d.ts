/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ffa1d62263d110cce8d1d205ec5b01e7)
// Runtime types generated with workerd@1.20251213.0 2025-12-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SpotifyMcpContainer";
	}
	interface Env {
		WORKER_URL: "https://vermillion-spotify-mcp.vermillion-a04.workers.dev";
		SPOTIFY_MCP: DurableObjectNamespace<import("./src/index").SpotifyMcpContainer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKER_URL">> {}
}
